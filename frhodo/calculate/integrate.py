...
"""
This is a modified version of SciPy v1.2.1 solve_ivp to allow 
exiting integration early if an error occurs within the ODE
"""
...
def solve_ivp(fun, t_span, y0, method='RK45', t_eval=None, dense_output=False,
    ...
    try:
        ...
        if "Temperature is invalid" in str(e):
            status = -3
        elif "Density is invalid" in str(e):
            status = -2
        else:
            status = -1
